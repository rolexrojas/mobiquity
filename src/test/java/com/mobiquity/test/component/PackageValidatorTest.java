package com.mobiquity.test.component;
...
public class PackageValidatorTest {
    ...
    public static int MAX_PACKAGE_ITEM_QUANTITY = 15;
    public static int MAX_PACKAGE_ITEM_COST = 100;

    public static void isValidPackageItem(PackageTest aPackage) throws APIException {
